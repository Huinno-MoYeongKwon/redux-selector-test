  ...
  return (
    <Card variant="success">
      <CardHeader>
        ...
        <CardDescription>
          <code className="font-mono bg-muted/50 px-1 rounded">createSelector + shallowEqual</code>
          <span className="mx-2 text-border/50">|</span>
          <span className="text-success">이중 보호</span>
        </CardDescription>
      </CardHeader>
      <CardContent>
...
useSelector(selector, shallowEqual); // 이중 보호`}
        </pre>
